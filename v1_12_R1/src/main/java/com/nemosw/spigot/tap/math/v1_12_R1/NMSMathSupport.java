...
import static com.nemosw.spigot.tap.math.RayTraceOption.*;

@SuppressWarnings({"Guava", "ConstantConditions"})
public final class NMSMathSupport extends MathSupport
{
    ...
    {
        return world.rayTrace(from, to, is(options, STOP_ON_LIQUID), is(options, IGNORE_BLOCK_WITHOUT_BOUNDING_BOX), is(options, RETURN_LAST_UNCOLLIDABLE_BLOCK));
    }
