package com.nemosw.spigot.tap.inventory.v1_12_R1;

import com.google.common.collect.MapMaker;
import com.nemosw.spigot.tap.entity.TapPlayer;
import com.nemosw.spigot.tap.entity.v1_12_R1.NMSEntitySupport;
import com.nemosw.spigot.tap.entity.v1_12_R1.NMSPlayer;
import com.nemosw.spigot.tap.inventory.InventoryManager;
...
public final class NMSInventoryManager extends InventoryManager
{

	private final Map<IInventory, TapInventory> cache;

	public NMSInventoryManager()
	{
		cache = new MapMaker().weakValues().makeMap();
	}

	@Override
	protected TapInventory fromInventory(org.bukkit.inventory.Inventory inventory)
	{
