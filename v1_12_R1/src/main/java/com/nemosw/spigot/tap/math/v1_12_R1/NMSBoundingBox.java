package com.nemosw.spigot.tap.math.v1_12_R1;
...
import static com.nemosw.spigot.tap.math.v1_12_R1.NMSMathSupport.*;
...
public final class NMSBoundingBox implements BoundingBox
{
    ...
    public <T extends org.bukkit.entity.Entity> List<T> getEntities(org.bukkit.World world, org.bukkit.entity.Entity exclude, Predicate<org.bukkit.entity.Entity> selector)
    {
        ...
        return (List<T>) Lists.transform(NMSMathSupport.getEntitiesInBox(nmsWorld, unwrapEntity(exclude), box, toNMSSelector(selector)), Entity::getBukkitEntity);
    }
    ...
    {
        return NMSMathSupport.wrapResult(calculateRayTrace(toVec3D(from), toVec3D(to)));
    }
