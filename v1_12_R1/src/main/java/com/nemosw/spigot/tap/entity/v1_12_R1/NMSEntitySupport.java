package com.nemosw.spigot.tap.entity.v1_12_R1;
...
import static com.nemosw.spigot.tap.entity.v1_12_R1.NMSEntityTypes.getEntityClass;

public final class NMSEntitySupport extends TapEntitySupport
{
    ...
    {
        Class<? extends Entity> nmsEntityClass = getEntityClass(entityClass);
