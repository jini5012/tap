...
import com.nemosw.spigot.tap.nms.v1_12_R1.NMSFireworkEffect;
import com.nemosw.spigot.tap.nms.v1_12_R1.NMSSound;
import com.nemosw.spigot.tap.packet.EffectPacket;
...
public final class NMSEffectPacket implements EffectPacket
{
	...
	static
	{
		...
		SoundCategory[] soundCategories = new SoundCategory[Math.max(com.nemosw.spigot.tap.SoundCategory.values().length, SoundCategory.values().length)];
		soundCategories[com.nemosw.spigot.tap.SoundCategory.MASTER.ordinal()] = SoundCategory.MASTER;
		soundCategories[com.nemosw.spigot.tap.SoundCategory.MUSIC.ordinal()] = SoundCategory.MUSIC;
		soundCategories[com.nemosw.spigot.tap.SoundCategory.RECORDS.ordinal()] = SoundCategory.RECORDS;
		soundCategories[com.nemosw.spigot.tap.SoundCategory.WEATHER.ordinal()] = SoundCategory.WEATHER;
		soundCategories[com.nemosw.spigot.tap.SoundCategory.BLOCKS.ordinal()] = SoundCategory.BLOCKS;
		soundCategories[com.nemosw.spigot.tap.SoundCategory.HOSTILE.ordinal()] = SoundCategory.HOSTILE;
		soundCategories[com.nemosw.spigot.tap.SoundCategory.NEUTRAL.ordinal()] = SoundCategory.NEUTRAL;
		soundCategories[com.nemosw.spigot.tap.SoundCategory.PLAYERS.ordinal()] = SoundCategory.PLAYERS;
		soundCategories[com.nemosw.spigot.tap.SoundCategory.AMBIENT.ordinal()] = SoundCategory.AMBIENT;
		soundCategories[com.nemosw.spigot.tap.SoundCategory.VOICE.ordinal()] = SoundCategory.VOICE;
	...
	@Override
	public NMSPacket sound(Sound sound, com.nemosw.spigot.tap.SoundCategory category, double x, double y, double z, float volume, float pitch)
	{
